...
docker run -it \
 -v /root/knp/.env:/knp_backend/.env \
 -v /root/knp/backup_config.json:/knp_backend/backup_config.json \
 -v /root/knp/sub.conf:/knp_backend/sub.conf \
 -v /root/knp/panel.conf:/knp_backend/panel.conf \
 --entrypoint "node" knp_backend config.js
