...
const AgentLogsPage = () => {
    ...
    const actions_array = ["LOGIN", "CREATE_USER", "EDIT_USER", "DELETE_USER" , "EDIT_SELF", "RESET_USER", "UNLOCK_USER", "ENABLE_USER", "DISABLE_USER","RECEIVE_DATA","SWITCH_COUNTRY","ADD_SUB_ACCOUNT","EDIT_SUB_ACCOUNT","DELETE_SUB_ACCOUNT", "BUY_VOLUME"]
