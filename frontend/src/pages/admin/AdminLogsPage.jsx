...
const AdminLogsPage = () => {
    ...
    const actions_array = ["LOGIN", "CREATE_USER", "EDIT_USER", "DELETE_USER", "CREATE_PANEL", "EDIT_PANEL", "DELETE_PANEL", "EDIT_SELF", "RESET_USER", "UNLOCK_USER", "CREATE_AGENT", "EDIT_AGENT", "DELETE_AGENT", "ENABLE_USER", "ENABLE_AGENT", "ENABLE_PANEL", "DISABLE_USER", "DISABLE_PANEL", "DISABLE_AGENT", "RECEIVE_DATA", "SWITCH_COUNTRY", "ADD_SUB_ACCOUNT", "EDIT_SUB_ACCOUNT", "DELETE_SUB_ACCOUNT", "ENABLE_AGENT_CREATE_ACCESS", "DISABLE_AGENT_CREATE_ACCESS", "ENABLE_AGENT_EDIT_ACCESS", "DISABLE_AGENT_EDIT_ACCESS", "ENABLE_AGENT_DELETE_ACCESS", "DISABLE_AGENT_DELETE_ACCESS", "ENABLE_ALL_AGENT_USERS", "DELETE_ALL_AGENT_USERS", "DELETE_ALL_AGENT_USERS", "RESTORE_DB", "BUY_VOLUME"]
